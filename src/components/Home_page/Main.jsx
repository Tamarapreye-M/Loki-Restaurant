	...
	return (
		<main className="w-full ">
			<section className="bg-white max-w-[1240px] md:w-3/4 w-3/5 mx-auto">
				<div className="w-full mx-auto justify-items-center flex flex-col-reverse md:grid md:grid-cols-2 lg:grid-cols-3 gap-3 py-32">
			...
			<section className=" bg-dark-green text-white my-12 py-14">
				<div className="max-w-[1240px] md:w-3/4 w-3/5 mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-28">
			...
			<section className="bg-white max-w-[1240px] md:w-3/4 w-3/5 mx-auto">
				<div className="w-full mx-auto justify-items-center grid md:grid-cols-2 lg:grid-cols-3 gap-3 py-32">
					<div>
						<img
							className="w-full"
			...
			<div className="w-full relative ">
				...
				<div className=" text-white text-center h-full absolute top-[50%] left-[50%] -translate-x-2/4 -translate-y-[18%] ">
					<h1 className="sm:text-xl text-lg md:text-4xl lg:text-5xl font-heading">
